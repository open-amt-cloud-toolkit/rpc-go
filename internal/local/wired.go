...
func (service *ProvisioningService) AddWiredSettings() (err error) {
	...
	service.PruneWiredConfigs()
	// err = service.EnableWifiPort()
	// if err != nil {
	// 	return err
	// }
	return service.ProcessWiredConfigs()
}

func (service *ProvisioningService) PruneWiredConfigs() (err error) {
	// get these handles BEFORE deleting the wifi profiles
	certHandles, keyPairHandles, err := service.GetWiredIeee8021xCerts()
	if err != nil {
		return err
	}
	wifiEndpointSettings, err := service.interfacedWsmanMessage.GetWiredSettings()
	if err != nil {
		return err
	}
...
func (service *ProvisioningService) GetWiredIeee8021xCerts() (certHandles, keyPairHandles []string, err error) {
...
func (service *ProvisioningService) ProcessWiredConfigs() error {
...
func (service *ProvisioningService) ProcessWiredConfig(wifiCfg *config.WifiConfig) (err error) {
