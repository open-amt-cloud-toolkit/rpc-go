...
typedef PCTSTR (WSAAPI *inet_ntop_type)( INT Family,  PVOID pAddr,  PTSTR pStringBuf,  size_t StringBufSize);
typedef INT (WSAAPI *inet_pton_type)( INT Family,  PCTSTR pszAddrString,  PVOID pAddrBuf);
